...
// pokémon follower specific overworlds start here... left off on gfx 1451 - galarian stunfisk which was inserted after all the others
    ...
    NEW_NPC_ENTRY(45), // Red EX
    NEW_NPC_ENTRY(46), // Kyle LG
    NEW_NPC_ENTRY(47), // Kyle
    NEW_NPC_ENTRY(48), // Corey
    NEW_NPC_ENTRY(49), // Logan
    NEW_NPC_ENTRY(50), // Umara
    NEW_NPC_ENTRY(51), // Agatha
    NEW_NPC_ENTRY(52), // Alder
    NEW_NPC_ENTRY(53), // Lance Arc
    NEW_NPC_ENTRY(54), // Benga
    NEW_NPC_ENTRY(55), // Bianca
    NEW_NPC_ENTRY(56), // Blue LG
    NEW_NPC_ENTRY(57), // Brendan E
    NEW_NPC_ENTRY(58), // Calem
    NEW_NPC_ENTRY(59), // Diantha
    NEW_NPC_ENTRY(60), // Elio
    NEW_NPC_ENTRY(61), // Hilbert
    NEW_NPC_ENTRY(62), // Hilda
    NEW_NPC_ENTRY(63), // Iris G
    NEW_NPC_ENTRY(64), // Iris C
    NEW_NPC_ENTRY(65), // Leaf LG
    NEW_NPC_ENTRY(66), // Leon
    NEW_NPC_ENTRY(67), // Lorelei
    NEW_NPC_ENTRY(68), // May C
    NEW_NPC_ENTRY(69), // May ORAS
    NEW_NPC_ENTRY(70), // N
    NEW_NPC_ENTRY(71), // Nate
    NEW_NPC_ENTRY(72), // Nemona
    NEW_NPC_ENTRY(73), // Rosa
    NEW_NPC_ENTRY(74), // Serena
    { 0xFFFF, 0, 0},
};
